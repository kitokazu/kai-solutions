      ...
      <Container>
          ...
          >
            {project.images.hero ? (
              ...
              <div className="flex h-full items-center justify-center bg-gradient-to-br from-kai-muted to-muted">
                <span className="text-6xl font-semibold text-kai/20">
        ...
        >
          ...
          <div className="rounded-lg border border-border bg-card p-5">
            ...
            <p className="mt-2 font-medium">{project.timeline}</p>
          </div>
        ...
        >
          ...
          <ul className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {project.features.map((feature, index) => (
              ...
              >
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-kai/10 text-kai text-sm font-medium">
                  {index + 1}
                </span>
        ...
        {project.results && (
          <motion.div
            className="mt-16 rounded-lg border border-kai/20 bg-kai-muted/30 p-6 lg:p-8"
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.4, delay: 0.7 }}
          >
            <h2 className="text-xl font-semibold text-kai">Results</h2>
            <p className="mt-4 text-lg">{project.results}</p>
          </motion.div>
        )}
          ...
          {prevProject ? (
            ...
            >
              ...
              <div>
                ...
                <div className="mt-1 font-medium text-foreground">{prevProject.title}</div>
              </div>
            </Link>
          ) : (
            <div />
          ...
          {nextProject ? (
            ...
            >
              <div>
                ...
                <div className="mt-1 font-medium text-foreground">{nextProject.title}</div>
              </div>
